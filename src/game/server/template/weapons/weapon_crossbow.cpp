...
void CCrossbowBolt::BoltTouch( CBaseEntity *pOther )
{
	...
	if ( pOther->m_takedamage != DAMAGE_NO )
	{
		...
		{
			CTakeDamageInfo	dmgInfo( this, GetOwnerEntity(), 1000.0f, DMG_NEVERGIB );
		...
		{
			CTakeDamageInfo	dmgInfo( this, GetOwnerEntity(), 1000.0f, DMG_BULLET | DMG_NEVERGIB );
			CalculateMeleeDamageForce( &dmgInfo, vecNormalizedVel, tr.endpos, 0.7f );
			dmgInfo.SetDamagePosition( tr.endpos );
			pOther->DispatchTraceAttack( dmgInfo, vecNormalizedVel, &tr );
		}
...
class CWeaponCrossbow : public CBaseSDKCombatWeapon
{
	DECLARE_CLASS( CWeaponCrossbow, CBaseSDKCombatWeapon);
public:
